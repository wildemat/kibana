...
- `setIndexMappingsAboutContent(content: IndexContent)`: sets the mappings description text and link to the proper documentation.
- `setIndexMappingsLearnMoreLink(content: IndexContent)`: adds content to the mappings tab of the index details page. The content is displayed in the right bottom corner, below the mappings docs link.
