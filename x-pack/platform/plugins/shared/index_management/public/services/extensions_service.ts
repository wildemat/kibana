...
export class ExtensionsService {
  ...
  private _indexMappingsContentAbout: IndexContent | null = null;
  private _indexMappingsLearnMoreLink: IndexMappingLearnMoreLink | null = null;
  ...
  public setup(): ExtensionsSetup {
    this.service = {
      ...
      setIndexMappingsAboutContent: this.setIndexMappingsAboutContent.bind(this),
      setIndexMappingsLearnMoreLink: this.setIndexMappingsLearnMoreLink.bind(this),
  ...
  private setIndexMappingsAboutContent(content: IndexContent) {
  ...
  private setIndexMappingsLearnMoreLink(link: IndexMappingLearnMoreLink) {
    if (this._indexMappingsLearnMoreLink) {
      throw new Error(`The extra content link for index mappings has already been set.`);
    } else {
      this._indexMappingsLearnMoreLink = link;
    }
  }
  ...
  public get indexMappingsLearnMoreLink() {
    return this._indexMappingsLearnMoreLink;
  }
